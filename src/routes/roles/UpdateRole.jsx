// src/routes/roles/UpdateRole.jsx
    ...
    try {
      const formData = new FormData()
       if(!name){
        ...
        const result = await AuthService.updateRole(id,formData);
        if(result?.data?.status == 200){
  ...
  return (
    <div className='form-wrapper'>
      ...
      <div className="d-flex justify-content-center my-3">
        <button className="button" onClick={updateRoleFunction}>Update role </button>
      </div>
